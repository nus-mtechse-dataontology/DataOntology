...
log "Starting ingestion of Currency Rate Data..."
...
log "Detected Script Relative Folder: $REL_DIR"
 ...
 uv run src/batch_main.py --ingestion-type="currency_rate" --project-path=$ROOT

log "Currency Rate ingestion Completed.."