...
log "Starting ingestion of Fact Flight Info Data..."
...
log "Detected Script Relative Folder: $REL_DIR"
 ...
 uv run src/batch_main.py --ingestion-type="fact_flight_info" --project-path=$ROOT

log "Fact Flight Info ingestion Completed.."