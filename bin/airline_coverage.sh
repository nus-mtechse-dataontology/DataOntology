...
log "Starting ingestion of Airline Coverage Data..."
...
log "Detected Script Relative Folder: $REL_DIR"
 ...
 uv run src/batch_main.py --ingestion-type="airline_coverage" --project-path=$ROOT

log "Airline Coverage ingestion Completed.."